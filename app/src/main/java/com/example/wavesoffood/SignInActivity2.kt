...
import com.example.wavesoffood.databinding.ActivitySignIn2Binding
...
class SignInActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.createAccountButton.setOnClickListener {
            ...
            email = binding.emailAdress.text.toString().toString()
                ...
                if (task.isSuccessful) {
                    ...
                    auth.signInWithCredential(credential).addOnCompleteListener { task ->
                        if (task.isSuccessful) {
                            ...
                            Toast.makeText(this, "Sign Inned.", Toast.LENGTH_SHORT).show()
                            finish()
                        } else {
